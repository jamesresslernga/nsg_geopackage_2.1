...
::
*Example 2.  At zoom level _n_ = 5, the ratio, meters(map)/pixel is 4013.857263245084 as explained in Example 1.  At the Pole, the ratio, meters(Earth)/pixil, is this number adjusted upwards by division by the UPS scale number 0.994 (exact).  The result is 4038.085777912559*
